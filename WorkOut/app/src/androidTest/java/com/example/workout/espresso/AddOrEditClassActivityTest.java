...
public class AddOrEditClassActivityTest
{
    ...
    @Test
    public void addingClassWithValidInformation()
    {
        ...
        onView(withId(R.id.courseNameEditText)).perform(ViewActions.typeText("testCourse"),
                closeSoftKeyboard());
        ...
        onView(withId(R.id.capacityEditText)).perform(ViewActions.
                typeText("30"), ViewActions.closeSoftKeyboard());
